...
/* UC3 */
Insert into employee_payroll values('Vaishnavi',70000,GETDATE());
Insert into employee_payroll values('Gourav',80000,GETDATE());
...
UPDATE employee_payroll SET Gender = 'F' where name = 'Vaishnavi';
UPDATE employee_payroll SET Gender = 'M' where name = 'Gourav';
...
/* UC7 */
INSERT INTO employee_payroll values (6,'Arti',60000,GETDATE(),'F');
Select * from employee_payroll;
